...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post departments_url, params: { department: { company_id: @department.company_id, name: @department.name, phone: @department.phone } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { company_id: @department.company_id, name: @department.name, phone: @department.phone } }
